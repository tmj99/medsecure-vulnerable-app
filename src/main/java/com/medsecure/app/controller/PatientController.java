...
public class PatientController {
    ...
    /**
     * FIXED: SQL Injection vulnerability resolved by using parameterized queries
     * User-supplied 'name' parameter is now properly sanitized through JPA parameters
     */
    ...
    public ResponseEntity<List<Patient>> searchPatients(@RequestParam String name) {
        ...
        query.setParameter("nameParam", "%" + name + "%"); // Parameterized input prevents SQL injection
