...
public class PatientController {
    ...
    /**
     * Fixed SQL injection vulnerability by using parameterized query with named parameters
     * instead of string concatenation to prevent malicious SQL injection attacks.
     */
    ...
    public ResponseEntity<List<Patient>> searchPatients(@RequestParam String name) {
        ...
        query.setParameter("nameParam", "%" + name + "%"); // Fixed: Using parameterized query to prevent SQL injection
