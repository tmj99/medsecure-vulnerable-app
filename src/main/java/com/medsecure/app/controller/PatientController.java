...
public class PatientController {
     ...
     * Now using parameterized query with named parameters to prevent SQL injection attacks.
     * User input is safely bound to parameters instead of being concatenated directly into the SQL string.
     */
    @SuppressWarnings("unchecked")
    @GetMapping("/search")
    public ResponseEntity<List<Patient>> searchPatients(@RequestParam String name) {
        // Fixed: Using parameterized query with named parameters to prevent SQL injection
