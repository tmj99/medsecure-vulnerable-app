...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            // Fixed: Enable CSRF protection for healthcare app security - only disable for specific read-only public APIs
            .csrf(csrf -> csrf
                .ignoringRequestMatchers("/api/public/health", "/api/public/info") // Only disable CSRF for specific stateless endpoints
            )
